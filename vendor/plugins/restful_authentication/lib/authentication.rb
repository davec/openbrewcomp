module Authentication
  ...
  self.bad_login_message = "must include only letters, numbers, and the characters .-_@".freeze

  self.name_regex        = /\A[^[:cntrl:]\\<>\/&]*\z/              # Unicode, permissive
  self.bad_name_message  = "must not include non-printing characters or the characters \\&gt;&lt;&amp;/".freeze
